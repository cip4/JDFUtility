...
<xsl:stylesheet exclude-result-prefixes="tbl" version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:tbl="urn:TheLanguageTable" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">

  <xsl:output doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" indent="yes" method="xml" omit-xml-declaration="no"/>
  ...
  <tbl:lang>
    ...
    <tbl:loc key="InvResPosition">
      <tbl:str lang="EN">Invalid position of Resource " ResourceLink</tbl:str>
   ...
   <tbl:loc key="CheckJDFWarnings">
    ...
    <tbl:loc key="DCMissRes">
      <tbl:str lang="EN">Device Capabilities: Missing Elements found</tbl:str>
      <tbl:str lang="DE">Device Capabilities: Fehlende Elemente gefunden:</tbl:str>
      <tbl:str lang="FR">Testing File: in French</tbl:str>
      <tbl:str lang="NL">Device Capabilities: Missing Resources - TBD Translate in xslt</tbl:str>
    </tbl:loc>
    <tbl:loc key="ActionPoolReport">
      <tbl:str lang="EN">Device Capabilities: Action Pool Report</tbl:str>
      <tbl:str lang="DE">Device Capabilities: Action Pool Ausgabe:</tbl:str>
      <tbl:str lang="FR">Testing File: in French</tbl:str>
      <tbl:str lang="NL">Device Capabilities: Action Pool Report - TBD Translate in xslt</tbl:str>
    </tbl:loc>
    <tbl:loc key="ActionReport">
      <tbl:str lang="EN">Results of an Action</tbl:str>
      <tbl:str lang="DE">Resultat einer Aktion</tbl:str>
      <tbl:str lang="FR">Testing File: in French</tbl:str>
      <tbl:str lang="NL">Device Capabilities: Action Report - TBD Translate in xslt</tbl:str>
    </tbl:loc>
    <tbl:loc key="TestReport">
      ...
      <tbl:str lang="FR">Testing File: in French</tbl:str>
      <tbl:str lang="NL">Device Capabilities: Test Report - TBD Translate in xslt</tbl:str>
    </tbl:loc>
  </tbl:lang>
  ...
  <xsl:template match="CheckOutput">
    ...
    <xsl:variable name="schemaErrors">
      <xsl:choose>
        <xsl:when test="TestFile/SchemaValidationOutput[@ValidationResult='NotPerformed']">-</xsl:when>
        <xsl:otherwise>
          <xsl:value-of select="count(TestFile/SchemaValidationOutput/Error) + count(TestFile/SchemaValidationOutput/FatalError)"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
  ...
  <xsl:template match="SchemaValidationOutput[@ValidationResult='NotPerformed']">
    <div class="schema">
      <h3>
        <xsl:call-template name="localize">
          <xsl:with-param name="string" select="'SchemaValidationNotPerformed'"/>
        </xsl:call-template>
      </h3>
    </div>
  </xsl:template>
  ...
  <xsl:template match="CheckJDFOutput">
    <div class="checkjdf">
      <h3 class="valid">
        <xsl:call-template name="localize">
          <xsl:with-param name="string" select="'CheckJDFValidationSuccessful'"/>
        </xsl:call-template>
      </h3>
    </div>
  </xsl:template>
