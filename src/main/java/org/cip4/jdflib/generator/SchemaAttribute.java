...
public class SchemaAttribute implements Serializable
{
	...
	{
		if (s != null)
			StringCollector.getAttribs().add(s);
		if ("Length".equals(s))
		{
			s = "LengthJDF";
		}
	...
	public void setStrEnumName(String nAttributeName)
	{
		...
		else if ("NodeStatus".equals(nAttributeName) || "MinStatus".equals(nAttributeName) || "MinLateStatus".equals(nAttributeName)) // JDF 1.3 NodeInfo
		{
			m_strEnumName = "Status";
		}
		else
	...
	{
		m_strUse = JDFConstants.EMPTYSTRING.equals(s) ? "optional" : s;
	}
